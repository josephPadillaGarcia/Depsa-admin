...
$args = array(
    "theme_location"=>"header-menu",	// Esto se verá más adelante, la posición debe estar registrada con register_nav_menu para poder seleccionarla.
    //"menu"=>"",				// Acepta, en este orden, id, slug o nombre del menú a mostrar.
    "container"=>"nav",		// Dentro de qué elemento se engloba el menú. Admite div y nav. Para no englobarlo en nada, usar false.
    //"container-class"=>"",	// Atributo class del container establecido antes.
    "container-id"=>"nav",		// Atributo id del container establecido antes.
    "menu_class"=>"hola",	// Atributo class del elemento ul que engloba al menú. Es posible establecer múltiples clases separadas por espacios.
